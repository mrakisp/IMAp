...
if (isset($characters->Title)) {
    ...
    try {
        ...
        $sql = "INSERT INTO movies (name, poster) SELECT * FROM (SELECT '$characters->Title', '$characters->Poster') AS tmp WHERE NOT EXISTS ( SELECT name FROM movies WHERE name = '$characters->Title') LIMIT 1"; 
